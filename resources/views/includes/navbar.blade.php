    ...
    <nav class="navbar navbar-dark navbar-expand-lg main-nav p-0 ">
        <div class="container-xl h-100">
            <a href="{{route("home")}}" class="logo me-3">
                <img src="assets/imgs/logo (2).png" width="150px" alt="">
            </a>
                ...
                <ul class="navbar-nav pt-4 pt-lg-0">
                    ...
                    <li class="dropdown mega-dropdown">
                        ...
                        <div class="dropdown-menu mega-dropdown-menu">
                            <div class="row">
                                <div class="col-12">
                                    <a href="{{route("manufacturers")}}">Maxxis Tyres</a>
                                </div>

                                <div class="col-12">
                                    <a href="{{route("manufacturers")}}">Pirelli Tyres</a>
                                </div>

                                <div class="col-12">
                                    <a href="{{route("manufacturers")}}">Dunlop Tyres</a>
                                </div>

                                <div class="col-12">
                                    <a href="{{route("manufacturers")}}">Bridgestone Tyres</a>
                                </div>

                                <div class="col-12">
                                    <a href="{{route("manufacturers")}}">Continental Tyres</a>
                                </div>

                                <div class="col-12">
                                    <a href="{{route("manufacturers")}}">Goodyear Tyres</a>
                                </div>

                                <div class="col-12">
                                    <a href="{{route("manufacturers")}}">Michelin Tyres</a>
                                </div>

                                <div class="col-12">
                                    <a href="{{route("manufacturers")}}">Nexen Tyres</a>
                                </div>
