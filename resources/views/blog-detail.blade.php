                        ...
                        <div class="related-blog card">
                            ...
                            <div class="card-body">
                                <p class="border-bottom m-0 py-2">
                                    <a href="{{route("blog-detail")}}"><i class="fa-solid fa-caret-right"></i> TYRE ZONE -Tyres: Your
                                        Ultimate
                                        Guide to Mobile Tyre Fitting</a>
                                </p>
                                <p class="border-bottom m-0 py-2">
                                    <a href="{{route("blog-detail")}}"><i class="fa-solid fa-caret-right"></i> Emergency Tyre Changing
                                        Services
                                        in Manchester – TYRE ZONE -tyres is Here To Help</a>
                                </p>
                                <p class=" m-0 py-2">
                                    <a href="{{route("blog-detail")}}"><i class="fa-solid fa-caret-right"></i> 15 Tips to Ensure
                                        Long-Lasting
