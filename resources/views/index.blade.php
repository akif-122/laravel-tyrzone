            ...
            <div class="tab-wrap">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tyre-fitting">Search by
                            Tyre</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="col-md-6 col-lg-4 my-3">
                <div class="recommended-card">
                    ...
                    <div class="rem-card-btn mt-5">
                        <a href="{{route("manufacturers")}}">View all Continental Tyres</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 my-3">
                <div class="recommended-card">
                    ...
                    <div class="rem-card-btn">
                        <a href="{{route("manufacturers")}}" class="blue-btn">View all Continental Tyres</a>
                    </div>
                </div>
            </div>
    ...
    <div class="about-header container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <img src="assets/imgs/about-image.jpg" width="100%" alt="">
            </div>
            <div class="col-lg-6">
